...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >= 10000 && nBestHeight <= 50000){
      nSubsidy = 25 * COIN;
    } else if(nBestHeight <= 100000 && nBestHeight > 50000){
      nSubsidy = 50 * COIN;
    } else if(nBestHeight <= 150000 && nBestHeight > 100000){
      nSubsidy = 75 * COIN;
    } else if(nBestHeight <= 200000 && nBestHeight > 150000){
      nSubsidy = 100 * COIN;
    } else if(nBestHeight <= 250000 && nBestHeight > 200000){
      nSubsidy = 75 * COIN;
    } else if(nBestHeight <= 300000 && nBestHeight > 250000){
      nSubsidy = 100 * COIN;
    } else if(nBestHeight <= 350000 && nBestHeight > 300000){
      nSubsidy = 75 * COIN;
    } else if(nBestHeight <= 400000 && nBestHeight > 350000){
      nSubsidy = 50 * COIN;
    } else if(nBestHeight <= 450000 && nBestHeight > 400000){
      nSubsidy = 25 * COIN;
    } else if(nBestHeight <= 500000 && nBestHeight > 450000){
      nSubsidy = 20 * COIN;
    } else{
      nSubsidy = 10 * COIN;
    }
